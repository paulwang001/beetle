...
use anyhow::Result;
use futures::pending;
use luffa_rpc_types::{Message, message_to, ContactsToken, ContactsEvent, RtcAction};
...
fn main() -> Result<()> {
    ...
    std::thread::spawn(move || loop {
        ...
        if to_id > 0 {
            ...
            let msg = Message::WebRtc { stream_id: 0, action: luffa_rpc_types::RtcAction::Status { timestamp: 0, code } };
