...
open class RustBuffer : Structure() {
    ...
    companion object {
        internal fun alloc(size: Int = 0) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_LuffaSDK_58aa_rustbuffer_alloc(size, status).also {
                if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_LuffaSDK_58aa_rustbuffer_free(buf, status)
        }
    }
...
internal interface _UniFFILib : Library {
    ...
    fun ffi_LuffaSDK_58aa_Client_object_free(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun LuffaSDK_58aa_Client_new(
    _uniffi_out_err: RustCallStatus
    ): Pointer

    fun LuffaSDK_58aa_Client_show_code(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun LuffaSDK_58aa_Client_contacts_offer(`ptr`: Pointer,`code`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Long

    fun LuffaSDK_58aa_Client_gen_offer_code(`ptr`: Pointer,`did`: Long,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun LuffaSDK_58aa_Client_contacts_group_create(`ptr`: Pointer,`invitee`: RustBuffer.ByValue,`tag`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Long

    fun LuffaSDK_58aa_Client_contacts_group_invite_member(`ptr`: Pointer,`gId`: Long,`invitee`: Long,`tag`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Byte

    fun LuffaSDK_58aa_Client_contacts_anwser(`ptr`: Pointer,`to`: Long,`offerId`: Long,`secretKey`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Long

    fun LuffaSDK_58aa_Client_send_msg(`ptr`: Pointer,`to`: Long,`msg`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Long

    fun LuffaSDK_58aa_Client_get_local_id(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun LuffaSDK_58aa_Client_get_peer_id(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun LuffaSDK_58aa_Client_get_did(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun LuffaSDK_58aa_Client_relay_list(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun LuffaSDK_58aa_Client_keys(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun LuffaSDK_58aa_Client_connect(`ptr`: Pointer,`peerId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Byte

    fun LuffaSDK_58aa_Client_disconnect(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): Byte

    fun LuffaSDK_58aa_Client_init(`ptr`: Pointer,`cfgPath`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun LuffaSDK_58aa_Client_start(`ptr`: Pointer,`key`: RustBuffer.ByValue,`tag`: RustBuffer.ByValue,`cb`: Long,
    _uniffi_out_err: RustCallStatus
    ): Long

    fun LuffaSDK_58aa_Client_stop(`ptr`: Pointer,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun LuffaSDK_58aa_Client_save_session(`ptr`: Pointer,`did`: Long,`tag`: RustBuffer.ByValue,`read`: RustBuffer.ByValue,`reach`: RustBuffer.ByValue,`msg`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun LuffaSDK_58aa_Client_session_list(`ptr`: Pointer,`top`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun LuffaSDK_58aa_Client_session_page(`ptr`: Pointer,`page`: Int,`size`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun LuffaSDK_58aa_Client_contacts_list(`ptr`: Pointer,`cType`: Byte,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun LuffaSDK_58aa_Client_search(`ptr`: Pointer,`query`: RustBuffer.ByValue,`offet`: Int,`limit`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun LuffaSDK_58aa_Client_recent_messages(`ptr`: Pointer,`did`: Long,`top`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun LuffaSDK_58aa_Client_find_contacts_tag(`ptr`: Pointer,`did`: Long,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun LuffaSDK_58aa_Client_meta_msg(`ptr`: Pointer,`data`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun LuffaSDK_58aa_Client_read_msg_with_meta(`ptr`: Pointer,`did`: Long,`crc`: Long,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun LuffaSDK_58aa_Client_gen_key(`ptr`: Pointer,`password`: RustBuffer.ByValue,`store`: Byte,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun LuffaSDK_58aa_Client_import_key(`ptr`: Pointer,`phrase`: RustBuffer.ByValue,`password`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun LuffaSDK_58aa_Client_save_key(`ptr`: Pointer,`name`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Byte

    fun LuffaSDK_58aa_Client_remove_key(`ptr`: Pointer,`name`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Byte

    fun LuffaSDK_58aa_Client_read_key_phrase(`ptr`: Pointer,`name`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun LuffaSDK_58aa_Client_generate_avatar(`ptr`: Pointer,`peerId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun LuffaSDK_58aa_Client_generate_nickname(`ptr`: Pointer,`peerId`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun LuffaSDK_58aa_Client_remove_local_msg(`ptr`: Pointer,`did`: Long,`crc`: Long,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun ffi_LuffaSDK_58aa_Callback_init_callback(`callbackStub`: ForeignCallback,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun LuffaSDK_58aa_public_key_to_id(`publicKey`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Long

    fun LuffaSDK_58aa_bs58_decode(`data`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Long

    fun ffi_LuffaSDK_58aa_rustbuffer_alloc(`size`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_LuffaSDK_58aa_rustbuffer_from_bytes(`bytes`: ForeignBytes.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_LuffaSDK_58aa_rustbuffer_free(`buf`: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun ffi_LuffaSDK_58aa_rustbuffer_reserve(`buf`: RustBuffer.ByValue,`additional`: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue
...
class Client(
    ...
    constructor() :
        this(
    rustCall() { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_new( _status)
})
    ...
    override protected fun freeRustArcPtr() {
        rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_LuffaSDK_58aa_Client_object_free(this.pointer, status)
        }
    }

    
    @Throws(ClientException::class)override fun `showCode`(): String? =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_show_code(it,  _status)
}
        }.let {
    ...
    @Throws(ClientException::class)override fun `contactsOffer`(`code`: String): ULong =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_contacts_offer(it, FfiConverterString.lower(`code`),  _status)
}
        }.let {
    ...
    @Throws(ClientException::class)override fun `genOfferCode`(`did`: ULong): String =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_gen_offer_code(it, FfiConverterULong.lower(`did`),  _status)
}
        }.let {
    ...
    @Throws(ClientException::class)override fun `contactsGroupCreate`(`invitee`: List<ULong>, `tag`: String?): ULong =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_contacts_group_create(it, FfiConverterSequenceULong.lower(`invitee`), FfiConverterOptionalString.lower(`tag`),  _status)
}
        }.let {
            FfiConverterULong.lift(it)
        }
    ...
    @Throws(ClientException::class)override fun `contactsGroupInviteMember`(`gId`: ULong, `invitee`: ULong, `tag`: String?): Boolean =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_contacts_group_invite_member(it, FfiConverterULong.lower(`gId`), FfiConverterULong.lower(`invitee`), FfiConverterOptionalString.lower(`tag`),  _status)
}
        }.let {
    ...
    @Throws(ClientException::class)override fun `contactsAnwser`(`to`: ULong, `offerId`: ULong, `secretKey`: List<UByte>): ULong =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_contacts_anwser(it, FfiConverterULong.lower(`to`), FfiConverterULong.lower(`offerId`), FfiConverterSequenceUByte.lower(`secretKey`),  _status)
}
        }.let {
            FfiConverterULong.lift(it)
        }
    ...
    @Throws(ClientException::class)override fun `sendMsg`(`to`: ULong, `msg`: List<UByte>): ULong =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_send_msg(it, FfiConverterULong.lower(`to`), FfiConverterSequenceUByte.lower(`msg`),  _status)
}
        }.let {
            FfiConverterULong.lift(it)
        }
    ...
    @Throws(ClientException::class)override fun `getLocalId`(): ULong? =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_get_local_id(it,  _status)
}
        }.let {
    ...
    @Throws(ClientException::class)override fun `getPeerId`(): String? =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_get_peer_id(it,  _status)
}
        }.let {
            FfiConverterOptionalString.lift(it)
        }
    ...
    @Throws(ClientException::class)override fun `getDid`(): String? =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_get_did(it,  _status)
}
        }.let {
            FfiConverterOptionalString.lift(it)
        }
    ...
    @Throws(ClientException::class)override fun `relayList`(): List<String> =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_relay_list(it,  _status)
}
        }.let {
    ...
    @Throws(ClientException::class)override fun `keys`(): List<String> =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_keys(it,  _status)
}
        }.let {
            FfiConverterSequenceString.lift(it)
        }
    ...
    @Throws(ClientException::class)override fun `connect`(`peerId`: String): Boolean =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_connect(it, FfiConverterString.lower(`peerId`),  _status)
}
        }.let {
            FfiConverterBoolean.lift(it)
        }
    ...
    @Throws(ClientException::class)override fun `disconnect`(): Boolean =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_disconnect(it,  _status)
}
        }.let {
            FfiConverterBoolean.lift(it)
        }
    ...
    @Throws(ClientException::class)override fun `init`(`cfgPath`: String?) =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_init(it, FfiConverterOptionalString.lower(`cfgPath`),  _status)
}
        }
    ...
    @Throws(ClientException::class)override fun `start`(`key`: String?, `tag`: String?, `cb`: Callback): ULong =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_start(it, FfiConverterOptionalString.lower(`key`), FfiConverterOptionalString.lower(`tag`), FfiConverterTypeCallback.lower(`cb`),  _status)
}
        }.let {
            FfiConverterULong.lift(it)
        }
    ...
    @Throws(ClientException::class)override fun `stop`() =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_stop(it,  _status)
}
        }
    ...
    @Throws(ClientException::class)override fun `saveSession`(`did`: ULong, `tag`: String, `read`: ULong?, `reach`: ULong?, `msg`: String?) =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_save_session(it, FfiConverterULong.lower(`did`), FfiConverterString.lower(`tag`), FfiConverterOptionalULong.lower(`read`), FfiConverterOptionalULong.lower(`reach`), FfiConverterOptionalString.lower(`msg`),  _status)
}
        }
    ...
    @Throws(ClientException::class)override fun `sessionList`(`top`: UInt): List<ChatSession> =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_session_list(it, FfiConverterUInt.lower(`top`),  _status)
}
        }.let {
    ...
    @Throws(ClientException::class)override fun `sessionPage`(`page`: UInt, `size`: UInt): List<ChatSession> =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_session_page(it, FfiConverterUInt.lower(`page`), FfiConverterUInt.lower(`size`),  _status)
}
        }.let {
            FfiConverterSequenceTypeChatSession.lift(it)
        }
    ...
    @Throws(ClientException::class)override fun `contactsList`(`cType`: UByte): List<ContactsView> =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_contacts_list(it, FfiConverterUByte.lower(`cType`),  _status)
}
        }.let {
    ...
    @Throws(ClientException::class)override fun `search`(`query`: String, `offet`: UInt, `limit`: UInt): List<String> =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_search(it, FfiConverterString.lower(`query`), FfiConverterUInt.lower(`offet`), FfiConverterUInt.lower(`limit`),  _status)
}
        }.let {
            FfiConverterSequenceString.lift(it)
        }
    ...
    @Throws(ClientException::class)override fun `recentMessages`(`did`: ULong, `top`: UInt): List<ULong> =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_recent_messages(it, FfiConverterULong.lower(`did`), FfiConverterUInt.lower(`top`),  _status)
}
        }.let {
    ...
    @Throws(ClientException::class)override fun `findContactsTag`(`did`: ULong): String? =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_find_contacts_tag(it, FfiConverterULong.lower(`did`),  _status)
}
        }.let {
            FfiConverterOptionalString.lift(it)
        }
    ...
    @Throws(ClientException::class)override fun `metaMsg`(`data`: List<UByte>): EventMeta =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_meta_msg(it, FfiConverterSequenceUByte.lower(`data`),  _status)
}
        }.let {
    ...
    @Throws(ClientException::class)override fun `readMsgWithMeta`(`did`: ULong, `crc`: ULong): EventMeta? =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_read_msg_with_meta(it, FfiConverterULong.lower(`did`), FfiConverterULong.lower(`crc`),  _status)
}
        }.let {
    ...
    @Throws(ClientException::class)override fun `genKey`(`password`: String, `store`: Boolean): String? =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_gen_key(it, FfiConverterString.lower(`password`), FfiConverterBoolean.lower(`store`),  _status)
}
        }.let {
            FfiConverterOptionalString.lift(it)
        }
    ...
    @Throws(ClientException::class)override fun `importKey`(`phrase`: String, `password`: String): String? =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_import_key(it, FfiConverterString.lower(`phrase`), FfiConverterString.lower(`password`),  _status)
}
        }.let {
            FfiConverterOptionalString.lift(it)
        }
    ...
    @Throws(ClientException::class)override fun `saveKey`(`name`: String): Boolean =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_save_key(it, FfiConverterString.lower(`name`),  _status)
}
        }.let {
            FfiConverterBoolean.lift(it)
        }
    ...
    @Throws(ClientException::class)override fun `removeKey`(`name`: String): Boolean =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_remove_key(it, FfiConverterString.lower(`name`),  _status)
}
        }.let {
            FfiConverterBoolean.lift(it)
        }
    ...
    @Throws(ClientException::class)override fun `readKeyPhrase`(`name`: String): String? =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_read_key_phrase(it, FfiConverterString.lower(`name`),  _status)
}
        }.let {
            FfiConverterOptionalString.lift(it)
        }
    ...
    @Throws(ClientException::class)override fun `generateAvatar`(`peerId`: String): String =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_generate_avatar(it, FfiConverterString.lower(`peerId`),  _status)
}
        }.let {
            FfiConverterString.lift(it)
        }
    ...
    @Throws(ClientException::class)override fun `generateNickname`(`peerId`: String): String =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_generate_nickname(it, FfiConverterString.lower(`peerId`),  _status)
}
        }.let {
            FfiConverterString.lift(it)
        }
    ...
    @Throws(ClientException::class)override fun `removeLocalMsg`(`did`: ULong, `crc`: ULong) =
        callWithPointer {
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_Client_remove_local_msg(it, FfiConverterULong.lower(`did`), FfiConverterULong.lower(`crc`),  _status)
}
        }
...
public object FfiConverterTypeClientError : FfiConverterRustBuffer<ClientException> {
    override fun read(buf: ByteBuffer): ClientException {
            ...
            17 -> ClientException.CustomException(FfiConverterString.read(buf))
...
public interface Callback {
    fun `onMessage`(`crc`: ULong, `from`: ULong, `to`: ULong, `msg`: List<UByte>)
...
public object FfiConverterTypeCallback: FfiConverterCallbackInterface<Callback>(
    ...
    override fun register(lib: _UniFFILib) {
        rustCall() { status ->
            lib.ffi_LuffaSDK_58aa_Callback_init_callback(this.foreignCallback, status)
        }
    }
}
...
fun `publicKeyToId`(`publicKey`: List<UByte>): ULong {
    ...
    rustCall() { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_public_key_to_id(FfiConverterSequenceUByte.lower(`publicKey`), _status)
})
}
...
fun `bs58Decode`(`data`: String): ULong {
    return FfiConverterULong.lift(
    rustCallWithError(ClientException) { _status ->
    _UniFFILib.INSTANCE.LuffaSDK_58aa_bs58_decode(FfiConverterString.lower(`data`), _status)
})
}
